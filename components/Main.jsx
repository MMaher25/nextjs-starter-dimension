...
const Main = ({ timeout, article, articleTimeout, onCloseArticle, onSwitchArticle }) => (
  <div id="main" style={timeout ? {display: 'flex'} : {display: 'none'}}>
    ...
    <article id="intro" className={`${article === 'intro' ? 'active' : ''} ${articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
      ...
      <p>Aenean ornare velit lacus, ac varius enim ullamcorper eu. Proin aliquam facilisis ante interdum congue. Integer mollis, nisl amet convallis, porttitor magna ullamcorper, amet egestas mauris. Ut magna finibus nisi nec lacinia. Nam maximus erat id euismod egestas. By the way, check out my <a onClick={() => {onSwitchArticle('work')}}>awesome work</a>.</p>
